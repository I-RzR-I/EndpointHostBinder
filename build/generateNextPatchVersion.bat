...
set applicationName=EndpointHostBinder
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\EndpointHostBinder\EndpointHostBinder.csproj')
set testProjectsPath=$('..\src\tests\EndpointTests\EndpointTests.csproj')
