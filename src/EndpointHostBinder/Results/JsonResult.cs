...
//  ***********************************************************************
//  <copyright file="JsonResult.cs" company="RzR SOFT & TECH">
...
namespace RzR.Infrastructure.EndpointHosting.Results
{
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    ///     An <see cref="IEndpointHostResult" /> that serializes a payload of type
    ///     <typeparamref name="T" /> to JSON, sets the Content-Type to
    ///     <c>application/json; charset=utf-8</c>, and writes the result with a configurable HTTP
    ...
    ///     <c>EndpointResults.Json&lt;object&gt;(payload)</c>). A null payload serializes to JSON
    ///     <c>null</c>.
    /// </typeparam>
    /// <seealso cref="T:RzR.Infrastructure.EndpointHosting.Abstractions.IEndpointHostResult" />
    /// =================================================================================================
    public sealed class JsonResult<T> : IEndpointHostResult
    {
        ...
        /// </param>
        /// =================================================================================================
        public JsonResult(T payload, int statusCode = 200, JsonSerializerOptions serializerOptions = null)
        {
            Payload = payload;
